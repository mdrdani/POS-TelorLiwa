                            ...
                            <div class="card-body">
                                <form @submit.prevent="submit">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" v-model="form.name" :class="{ 'is-invalid' : errors.name}" placeholder="Role Name" class="form-control">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-check form-check-inline" v-for="(permission, index) in permissions" :key="index">
                                            <input type="checkbox" v-model="form.permissions" :value="permission.name" :id="`check-${permission.id}`" class="form-check-input">
                                            <label :for="`check-${permission.id}`" class="form-check-label">{{ permission.name }} </label>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12">
